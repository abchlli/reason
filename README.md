...
* Curl ([documentation](https://curl.se/documentations/tutorial.html), [source](https://github.com/curl/curl), [manual](https://manned.org/man/curl))
...
* TCC ([documentation](https://bellard.org/tcc/tcc-doc.html), [source](https://repo.or.cz/w/tinycc.git), [manual](https://manned.org/man/tcc))
